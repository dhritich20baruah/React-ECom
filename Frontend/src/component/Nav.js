...
const Nav = () => {
    ...
    return (
        <>
            <div>
                <ul className=' flex flex-row text-indigo-700 h-12 text-lg md:space-x-3 space-x-1'>
                    <li></li>
                    <li className="text-3xl font-bold">Maple</li>
                    <li className='m-3'><input type="text" className='bg-white w-56 border-none px-2 font-thin italic' placeholder='Search items....'/><i className="material-icons hover:text-yellow-400 py-3 hover:cursor-pointer ">search</i></li>
                    <li>
                        <div>                            
             ...
             <nav className='flex flex-row justify-between bg-black font-bold'>
                ...
                <ul className='hidden md:flex flex-row text-white h-12 text-lg space-x-10 '>
                    ...
                    <li className='hover:cursor-pointer hover:bg-white hover:text-orange-700 p-2'><Link to="about">About</Link></li>
                    <li className='hover:cursor-pointer hover:bg-white hover:text-orange-700 p-2'><Link to="shop">Shop</Link></li>
